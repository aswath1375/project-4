...
<div class="col-md-6"><br>
			...
			<b style="color: red"></b>LEET AUCTION MANAGEMENT</h1>
		</div>
<div class="col-md-3">
<img src="images/logo.jpg" class="img-responsive" style="border-radius : 20px" />
</div>
...
<div class="container">
    	<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login" style="background-color:#cdf7ef;">
					<div class="panel-heading" style="background-color:#068c71;">
						<div class="row">
							<div class="col-xs-12">
								<a href="#" style="padding-left: 5px ; font-family: Times New Roman ; color: #cdf7ef ; " class="active" id="login-form-link"> WE WILL GET IN TOUCH </a>
							</div>
							
						</div>
						<hr>
					</div>
					<div class="panel-body" style="color:#068c71;">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form"  method="post" role="form" style="display: block;>
									<div class="form-group">
								<i><h3><b><span>Phone No:</span></b>7448444432</h3>
									<h3><b><span>Email Id:</span></b> &nbsp tamilarasimarimuthu0@gmail.com</h3>
									<h3><b><span>Address:</span></b>&nbsp Arulmigu Annamalaiyar <br>
									 &nbsp &nbsp  &nbsp  &nbsp  &nbsp &nbsp &nbsp &nbsp Consulting,No:5/473-A,<br>
									 &nbsp  &nbsp  &nbsp  &nbsp &nbsp  &nbsp &nbsp &nbsp Dharapuram Road,Oddanchatram</h3>
									</i>
									</div>
