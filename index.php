			...
			<div class="container" style="padding-left: 290px">
				<ul class="list-inline">
					...
					<li><a href="contact.php">CONTACT US</a></li>
												...
												<br><br><br>
												<img src="images/market.jpg" style="border-radius: 5px ; padding-left: 50px" height="400px" width="1448px" /><br><br><br>
				...
				<div class="col-md-12 col-md-offset-">
					<div class="panel panel-login">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12" style="background-image: url('images/b1.jpg')">
									<p style="text-align: justify ; font-size: 20px ; color: green ; font-family: Times New Roman "> <b style="color: red">A</b>n online auction (also electronic auction, e-auction, virtual auction, or eAuction) is an auction held over the internet and accessed by internet connected devices. Similar to in-person auctions, online auctions come in a variety of types, with different bidding and selling rules.</p>
									<p style="text-align: justify ; font-size: 20px ; color: green ; font-family: Times New Roman "> <b style="color: red">W</b>e reviewed 28 different online auction websites to determine the best options available. The site should have a good reputation and have reasonable fees for both the buyer and seller. To determine a company’s reputation, we looked at real customer reviews. Here are our top picks.</p>
