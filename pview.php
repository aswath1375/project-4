		...
		<div class="menu" style="background-color: white ; font-family: Times New Roman">
			<div class="container" style="padding-left: 290px">
				<ul class="list-inline">
					...
					<li><a href="view.php" >View Buyer</a></li>
					<li><a href="pview.php" class="active">View Vehicle</a></li>
			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-family: Times New Roman"> View Vehicle</h3>
