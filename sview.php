		...
		<div class="menu" style="background-color: white ; font-family: Times New Roman">
			<div class="container" style="padding-left: 290px">
				<ul class="list-inline">
					<li><a href="sview.php" class="active">View Sellers</a></li>
					<li><a href="bview.php" >View Buyer</a></li>
			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-family: Times New Roman"> View Sellers</h3>
					...
					<div class="panel-body">
						<input type="text" class="form-control" style="font-family: Times New Roman" id="dev-table-filter" data-action="filter" data-filters="#dev-table" placeholder="Filter" />
					</div>
                    ...
                    <table class="table table-hover" id="dev-table" style="font-family: Times New Roman">
						...
						<tbody>
                         <?php 
					$select=mysql_query("select * from seller") or die(mysql_error());
