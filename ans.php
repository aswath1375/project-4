...
<div class="col-md-6"><br>
			...
			<b style="color: red"></b>E-FARMING</h1>
		</div>
<div class="col-md-3">
<img src="images/logo.jpg" class="img-responsive" style="border-radius : 20px" />
</div>
	...
	<br><br><br><br>
<footer style="background-color: #135F0B ; border-radius: 30px"><br><br>
<h5 style="color: white ; text-align: center ; text-size: 20px">&copy copyright by Online Antique Auction </h5><br><br>
</footer>
